...
public class RelationshipDatabaseExecutionInstanceStorage implements ExecutionInstanceStorage {
    ...
    public void insert(ExecutionInstance executionInstance,
        ...
        ExecutionInstanceDAO executionInstanceDAO = (ExecutionInstanceDAO)SpringContextUtil.getBean(
            "executionInstanceDAO");
    ...
    private ExecutionInstanceEntity buildExecutionInstanceEntity(ExecutionInstance executionInstance) {
        ...
        if (null != incomeTransition) {
            ...
            executionInstanceEntity.setIncomeActivityInstanceId(
                Long.valueOf(incomeTransition.getSourceActivityInstanceId()));
    ...
    private ExecutionInstance buildExecutionInstance(ExecutionInstance executionInstance,
                                                     ExecutionInstanceEntity executionInstanceEntity) {
    ...
    public List<ExecutionInstance> findActiveExecution(String processInstanceId,
        ...
        ExecutionInstanceDAO executionInstanceDAO = (ExecutionInstanceDAO)SpringContextUtil.getBean(
            "executionInstanceDAO");
        List<ExecutionInstanceEntity> executionInstanceEntities = executionInstanceDAO.findActiveExecution(
            Long.valueOf(processInstanceId));
        return transform(executionInstanceEntities);
    }
    ...
    public List<ExecutionInstance> findByActivityInstanceId(String processInstanceId, String activityInstanceId,
        ...
        ExecutionInstanceDAO executionInstanceDAO = (ExecutionInstanceDAO)SpringContextUtil.getBean(
            "executionInstanceDAO");
        List<ExecutionInstanceEntity> executionInstanceEntities = executionInstanceDAO.findByActivityInstanceId(
            Long.valueOf(processInstanceId), Long.valueOf(activityInstanceId));
        return transform(executionInstanceEntities);
    }
    ...
    private List<ExecutionInstance> transform(List<ExecutionInstanceEntity> executionInstanceEntities) {
