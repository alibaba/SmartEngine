-- ===========================================
-- SmartEngine archive tables - MySQL HASH partitioned version
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Process instance archive table'
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Task instance archive table'
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Execution instance archive table'
PARTITION BY HASH (`process_instance_id`) PARTITIONS 16;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Activity instance archive table'
PARTITION BY HASH (`process_instance_id`) PARTITIONS 16;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Variable instance archive table'
PARTITION BY HASH (`process_instance_id`) PARTITIONS 16;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Task assignee instance archive table'
PARTITION BY HASH (`process_instance_id`) PARTITIONS 16;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Supervision instance archive table'
PARTITION BY HASH (`process_instance_id`) PARTITIONS 16;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Notification instance archive table'
PARTITION BY HASH (`process_instance_id`) PARTITIONS 16;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Task transfer record archive table'
PARTITION BY HASH (`process_instance_id`) PARTITIONS 16;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Assignee operation record archive table'
PARTITION BY HASH (`process_instance_id`) PARTITIONS 16;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Process rollback record archive table'
PARTITION BY HASH (`process_instance_id`) PARTITIONS 16;
