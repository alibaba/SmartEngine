...
/**
 * Verify that StorageRouter has registered both DATABASE and MEMORY mode
...
public class StorageRouterRegistryTest {
    ...
    @Test
    public void testMemoryModeRegistered() {
        StorageRouter router = processEngineConfiguration.getStorageRouter();
        assertNotNull(router);

        assertNotNull("MEMORY ProcessInstanceStorage should be registered",
            router.getStorage(ProcessInstanceStorage.class, StorageMode.MEMORY));
        assertNotNull("MEMORY ExecutionInstanceStorage should be registered",
            router.getStorage(ExecutionInstanceStorage.class, StorageMode.MEMORY));
        assertNotNull("MEMORY ActivityInstanceStorage should be registered",
            router.getStorage(ActivityInstanceStorage.class, StorageMode.MEMORY));
        assertNotNull("MEMORY TaskInstanceStorage should be registered",
            router.getStorage(TaskInstanceStorage.class, StorageMode.MEMORY));
        assertNotNull("MEMORY TaskAssigneeStorage should be registered",
            router.getStorage(TaskAssigneeStorage.class, StorageMode.MEMORY));
        assertNotNull("MEMORY VariableInstanceStorage should be registered",
            router.getStorage(VariableInstanceStorage.class, StorageMode.MEMORY));
    }

    @Test
    public void testDatabaseAndMemoryAreDifferentInstances() {
        StorageRouter router = processEngineConfiguration.getStorageRouter();

        Object dbStorage = router.getStorage(ProcessInstanceStorage.class, StorageMode.DATABASE);
        Object memStorage = router.getStorage(ProcessInstanceStorage.class, StorageMode.MEMORY);

        assertTrue("DATABASE and MEMORY ProcessInstanceStorage should be different instances",
        ...
        assertTrue("MEMORY storage should be Custom implementation",
