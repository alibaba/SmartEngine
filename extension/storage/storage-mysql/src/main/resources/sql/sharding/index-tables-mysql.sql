-- ===========================================
-- Index tables for sharding mode - MySQL version
-- These tables are NOT partitioned
-- They serve as global indexes for user-centric queries
-- ===========================================
...
-- ===========================================
CREATE TABLE `se_user_notification_index` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `tenant_id` varchar(64) DEFAULT NULL,
