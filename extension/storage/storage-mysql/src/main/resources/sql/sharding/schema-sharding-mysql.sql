-- ===========================================
-- SmartEngine core tables - MySQL HASH partitioned version
...
CREATE TABLE `se_process_instance` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Process instance table'
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Activity instance table'
...
CREATE TABLE `se_execution_instance` (
  ...
  `tenant_id` varchar(64) DEFAULT NULL COMMENT 'tenant id',
  PRIMARY KEY (`id`, `process_instance_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Execution instance table'
PARTITION BY HASH (`process_instance_id`) PARTITIONS 16;
...
CREATE TABLE `se_task_instance` (
  ...
  `tenant_id` varchar(64) DEFAULT NULL COMMENT 'tenant id',
  PRIMARY KEY (`id`, `process_instance_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Task instance table'
PARTITION BY HASH (`process_instance_id`) PARTITIONS 16;
...
CREATE TABLE `se_task_assignee_instance` (
  ...
  `tenant_id` varchar(64) DEFAULT NULL COMMENT 'tenant id',
  PRIMARY KEY (`id`, `process_instance_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Task assignee instance table'
PARTITION BY HASH (`process_instance_id`) PARTITIONS 16;
...
CREATE TABLE `se_variable_instance` (
  ...
  `tenant_id` varchar(64) DEFAULT NULL COMMENT 'tenant id',
  PRIMARY KEY (`id`, `process_instance_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Variable instance table'
PARTITION BY HASH (`process_instance_id`) PARTITIONS 16;
