 ...
 * @create 2020-07-16 9:42 下午 please use @com.alibaba.smart.framework.engine.smart.Property,
 *     Example: com.alibaba.smart.framework.engine.test.cases.extensions.CompositePropertiesTest
 */
@Data
@Deprecated
public class ProcessField implements ExtensionDecorator {
    ...
    public static final QName qtype = new QName(PROCESS_NS, "field");
