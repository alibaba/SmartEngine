...
public class LogEnhancedMvelExpressionEvaluator implements ExpressionEvaluator {
    ...
    private static final Logger LOGGER =
            LoggerFactory.getLogger(LogEnhancedMvelExpressionEvaluator.class);
    ...
    public Object eval(String expression, Map<String, Object> vars, boolean needCached) {
        ...
        LOGGER.info(
                "BEFORE: PvmActivityTask thread id  is {}, each param  is {} ,{} ",
        ...
        LOGGER.info(
                "AFTER: PvmActivityTask thread id  is {}, each param is {} , {} , {} ",
                Thread.currentThread().getId(),
                expression,
                vars,
                result);
