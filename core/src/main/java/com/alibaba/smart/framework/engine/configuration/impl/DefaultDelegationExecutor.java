...
public class DefaultDelegationExecutor implements DelegationExecutor {
    ...
    protected void execute(ExecutionContext context, String className, Activity activity) {
        ...
        InstanceAccessor instanceAccessor = processEngineConfiguration.getInstanceAccessor();
        ...
        if (delegation instanceof ContextBoundedJavaDelegation) {
            ContextBoundedJavaDelegation contextBoundedJavaDelegation =
                    (ContextBoundedJavaDelegation) delegation;
    ...
    protected void dealException(
            ExceptionProcessor exceptionProcessor, Exception exception, ExecutionContext context) {
