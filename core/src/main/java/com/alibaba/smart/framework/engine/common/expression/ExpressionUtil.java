...
public abstract class ExpressionUtil {
    ...
    public static Boolean eval(ExecutionContext context, ConditionExpression conditionExpression) {
        ...
        Object eval =
                ExpressionUtil.eval(
                        context.getRequest(),
                        type,
                        conditionExpression.getExpressionContent(),
    ...
    public static Boolean eval(
        ...
        Object eval =
                ExpressionUtil.eval(
                        requestContext, type, expressionContent, processEngineConfiguration);
    ...
    private static Object eval(
        ...
        ConfigurationOption configurationOption =
                processEngineConfiguration
                        .getOptionContainer()
                        .get(ConfigurationOption.EXPRESSION_COMPILE_RESULT_CACHED_OPTION.getId());

        ExpressionEvaluator expressionEvaluator =
                processEngineConfiguration.getExpressionEvaluator();
        Object result =
                expressionEvaluator.eval(
                        expression, requestContext, configurationOption.isEnabled());

        LOGGER.debug(
                "expressionEvaluator.result result is {}, each param is {} {} ",
                result,
                expression,
                requestContext);
