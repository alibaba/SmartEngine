...
public class RequestMapSpecialKeyConstant {
    ...
    public static final String PROCESS_DEFINITION_TYPE =
            $_SMART_ENGINE_$_PREFIX + "process_definition_type";

    public static final String PROCESS_INSTANCE_START_USER_ID =
            $_SMART_ENGINE_$_PREFIX + "start_user_id";
    ...
    public static final String PROCESS_INSTANCE_COMMENT =
            $_SMART_ENGINE_$_PREFIX + "PROCESS_INSTANCE_COMMENT";

    public static final String PROCESS_INSTANCE_ABORT_REASON =
            $_SMART_ENGINE_$_PREFIX + "PROCESS_INSTANCE_ABORT_REASON";
    ...
    public static final String TASK_INSTANCE_EXTENSION =
            $_SMART_ENGINE_$_PREFIX + "task_instance_extension";

    public static final String TASK_INSTANCE_PRIORITY =
            $_SMART_ENGINE_$_PREFIX + "task_instance_priority";
    ...
    // TODO 修改为小写 非兼容升级
    public static final String TASK_INSTANCE_CLAIM_USER_ID =
            $_SMART_ENGINE_$_PREFIX + "TASK_INSTANCE_CLAIM_USER_ID";

    public static final String TASK_INSTANCE_COMMENT =
            $_SMART_ENGINE_$_PREFIX + "TASK_INSTANCE_COMMENT";
    ...
    public static final String LATCH_WAIT_TIME_IN_MILLISECOND =
            $_SMART_ENGINE_$_PREFIX + "latchWaitTime";
}
