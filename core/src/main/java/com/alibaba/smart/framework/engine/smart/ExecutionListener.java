...
public class ExecutionListener implements ExtensionDecorator, CustomExtensionElement {
    ...
    public static final String xmlLocalPart = "executionListener";
    ...
    public void decorate(ExtensionElements extensionElements, ParseContext context) {
        ListenerAggregation eventListenerAggregation =
                (ListenerAggregation) extensionElements.getDecorationMap().get(getDecoratorType());

        if (null == eventListenerAggregation) {
            eventListenerAggregation = new ListenerAggregation();
            extensionElements
                    .getDecorationMap()
                    .put(this.getDecoratorType(), eventListenerAggregation);
        }
        ...
        for (String event : events) {
            ...
            Map<String, List<String>> eventListenerMap =
                    eventListenerAggregation.getEventListenerMap();
