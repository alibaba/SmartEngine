...
public class DefaultXmlParserFacade implements XmlParserFacade, ProcessEngineConfigurationAware {
    ...
    public void start() {
        this.bindings =
                processEngineConfiguration
                        ...
                        .getScanResult()
                        .get(ExtensionConstant.ELEMENT_PARSER)
                        .getBindingMap();
        ...
        for (Entry<Class, Object> entry : entries) {
            try {
                ...
                if (!isSmartEngineCustomElement) {
                    ...
                    Map<String, Object> magicExtension =
                            processEngineConfiguration.getMagicExtension();

                    if (MapUtil.isNotEmpty(magicExtension)) {
                        Map<String, String> fallBackMap =
                                (Map<String, String>) magicExtension.get("fallBack");
                        ...
                        if (MapUtil.isNotEmpty(fallBackMap)) {
                            ...
                            for (Entry<String, String> entryX : fallBackMap.entrySet()) {
                                QName qnamex =
                                        new QName(entryX.getKey(), localPart, entryX.getValue());
                                qNames.add(qnamex);
                            }
    ...
    public Object parseAttribute(
            QName attributeQName, XMLStreamReader reader, ParseContext context) {
