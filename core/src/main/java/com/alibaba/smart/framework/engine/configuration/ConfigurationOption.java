...
public interface ConfigurationOption {
    ...
    ConfigurationOption EXPRESSION_COMPILE_RESULT_CACHED_OPTION =
            new ExpressionCompileResultCachedOption();

    ConfigurationOption SERVICE_ORCHESTRATION_OPTION = new ServiceOrchestrationEnabledOption();
    ConfigurationOption PROCESS_DEFINITION_MULTI_TENANT_SHARE_OPTION =
            new ProcessDefinitionMultiTenantShareOption(true);
