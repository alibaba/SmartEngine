...
public class DefaultListenerExecutor implements ListenerExecutor {
    ...
    public void execute(
            EventConstant event,
            ExtensionElementContainer extensionElementContainer,
        ...
        if (null != extensionElements) {
            ...
            ListenerAggregation extension =
                    (ListenerAggregation)
                            extensionElements
                                    .getDecorationMap()
                                    .get(ExtensionElementsConstant.EXECUTION_LISTENER);
            ...
            if (null != extension) {
                ...
                if (CollectionUtil.isNotEmpty(listenerClassNameList)) {
                    InstanceAccessor instanceAccessor =
                            context.getProcessEngineConfiguration().getInstanceAccessor();
