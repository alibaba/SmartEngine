...
public class TextAnnotationParser extends AbstractElementParser<TextAnnotation>
        implements Serializable {

    public static final QName qtype =
            new QName(BpmnNameSpaceConstant.BPMNDI_NAME_SPACE, "textAnnotation");
    ...
    @Override
    public TextAnnotation parseElement(XMLStreamReader reader, ParseContext context)
