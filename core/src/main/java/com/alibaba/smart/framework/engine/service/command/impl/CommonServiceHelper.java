...
public abstract class CommonServiceHelper {
    ...
    public static ProcessInstance insertAndPersist(
        ...
        ProcessInstance newProcessInstance =
                processInstanceStorage.insert(processInstance, processEngineConfiguration);

        persistVariableInstanceIfPossible(
                request,
                processEngineConfiguration,
                newProcessInstance,
                AdHocConstant.DEFAULT_ZERO_VALUE);
    ...
    public static ProcessInstance createExecution(
            String executionInstanceId,
            ProcessInstance processInstance,
            Map<String, Object> request,
            ProcessEngineConfiguration processEngineConfiguration) {
        ...
        persistVariableInstanceIfPossible(
                request, processEngineConfiguration, newProcessInstance, executionInstanceId);
    ...
    private static void persist(
        ...
        AnnotationScanner annotationScanner = processEngineConfiguration.getAnnotationScanner();
        ActivityInstanceStorage activityInstanceStorage =
                annotationScanner.getExtensionPoint(
        ...
        for (ActivityInstance activityInstance : activityInstances) {
            ...
            List<ExecutionInstance> executionInstanceList =
                    activityInstance.getExecutionInstanceList();
    ...
    // TUNE too many args
    private static void persistInstance(
            ExecutionInstanceStorage executionInstanceStorage,
            TaskInstanceStorage taskInstanceStorage,
            TaskAssigneeStorage taskAssigneeStorage,
        ...
        if (null != executionInstance) {
            ...
            if (null != taskInstance) {
                ...
                List<TaskAssigneeInstance> taskAssigneeInstances =
                        taskInstance.getTaskAssigneeInstanceList();
                ...
                if (null != taskAssigneeInstances) {
                    for (TaskAssigneeInstance taskAssigneeInstance : taskAssigneeInstances) {
                        ...
                        taskAssigneeInstance.setProcessInstanceId(
                                taskInstance.getProcessInstanceId());
                        taskAssigneeStorage.insert(
                                taskAssigneeInstance, processEngineConfiguration);
                    }
                }
