...
public class ConditionExpressionParser extends AbstractElementParser<ConditionExpressionImpl> {
    ...
    @Override
    public ConditionExpressionImpl parseElement(XMLStreamReader reader, ParseContext context)
        ...
        if (null == finalExpressionType) {
            throw new EngineException(
                    "expression type should not be empty for expression content:" + content);
        }
