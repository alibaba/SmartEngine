...
public class FullMultiInstanceTest {
    ...
    //
    //    //FIXME 2
    //    List<TaskInstance>  assertedTaskInstanceList=   taskQueryService.findPendingTaskList(pendingTaskQueryParam,null);
    //    Assert.assertEquals(3,assertedTaskInstanceList.size());
    //
    //
    //    assertedTaskInstanceList=   taskQueryService.findAllPendingTaskList(processInstance.getInstanceId(),pendingTaskQueryParam);
    //    Assert.assertEquals(3,assertedTaskInstanceList.size());
    //
    //
    //
