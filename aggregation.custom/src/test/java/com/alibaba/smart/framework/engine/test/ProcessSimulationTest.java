...
public class ProcessSimulationTest {
    ...
    public void test() throws Exception {
        ...
        List<Activity> activitieList =  processSimulation.simulateOutcomingActivities("processSimulation","1.0.0","receiveTask0",null);
        ...
        //activitieList =  processSimulation.simulateOutcomingActivities("processSimulation","1.0.0","receiveTask1",null);
        //Assert.assertNotNull(activitieList);
        ...
        activitieList =  processSimulation.simulateOutcomingActivities("processSimulation","1.0.0","receiveTask1",simulationContext);
        Assert.assertNotNull(activitieList);
        Assert.assertEquals(1,activitieList.size());
