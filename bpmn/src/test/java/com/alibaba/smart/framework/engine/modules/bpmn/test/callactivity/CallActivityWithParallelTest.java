package com.alibaba.smart.framework.engine.modules.bpmn.test.callactivity;
...
public class CallActivityWithParallelTest {
    ...
    private void deploy() {
        ...
        repositoryCommandService
            .deploy("process-def/callactivity/parent-process-parallel.bpmn20.xml");
        repositoryCommandService
            .deploy("process-def/callactivity/sub-process.bpmn20.xml");
        repositoryCommandService
            .deploy("process-def/callactivity/sub-process-suspend.bpmn20.xml");
    }
