 ...
 */
public class InclusiveGatewayParser extends AbstractBpmnActivityParser<InclusiveGateway> implements StAXArtifactParser<InclusiveGateway> {
    ...
    @Override
    public InclusiveGateway parseModel(XMLStreamReader reader, ParseContext context) throws ParseException,
            XMLStreamException {
